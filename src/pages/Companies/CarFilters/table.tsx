import { deleteCar, upsertCarRules } from "../../../services/rules";
  ...
  return (
    <div className="mt-6">
      <div className="flex justify-between items-center">
        <h2 className="font-bold mb-3 text-gray-800">تأمين سيارات</h2>
        <button
          ...
          hover:bg-gray-50 ${checked ? "bg-blue-50" : ""}`}>
                ...
                <td className="p-3 border-b border-gray-200 h-[50px]">
                  <EditableCell
                    ...
                    value={editRowId === r.id ? editData.type : r.type}
